  ...
  <div class="max-w-7xl mx-auto p-4 md:p-8 font-sans bg-gray-50/50 min-h-screen">
    ...
    <div v-if="!isUnlocked" class="flex flex-col items-center justify-center min-h-[80vh]">
         <div class="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md text-center border border-gray-200">
            ...
            <button @click="unlockAdmin" class="w-full bg-slate-900 text-white py-4 rounded-xl font-bold text-lg hover:bg-slate-800 transition-all shadow-lg shadow-slate-200">
               ដោះសោរ (Unlock)
            </button>
         </div>
    </div>
    ...
    <div v-else>
        <div class="flex flex-col xl:flex-row justify-between items-center mb-8 gap-4">
            ...
            <div class="flex gap-4">
                 <button @click="isUnlocked = false" class="text-red-500 font-bold bg-white px-4 py-2 rounded-lg border hover:bg-red-50">🔒 Lock Again</button>
